...
def calculate_plane_angle(coords1: np.ndarray, coords2: np.ndarray) -> float:
    """
...
def calculate_centroid_distance(coords1: np.ndarray, coords2: np.ndarray) -> float:
    """
...
def _project_to_2d(coords: np.ndarray, u: np.ndarray, v: np.ndarray) -> np.ndarray:
    """
...
def calculate_pi_overlap(
    coords1: np.ndarray, coords2: np.ndarray, use_shapely: bool = True
) -> float:
    """
...
def calculate_tilt_angle(coords1: np.ndarray, coords2: np.ndarray) -> float:
    """
